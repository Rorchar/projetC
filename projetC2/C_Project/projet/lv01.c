        ...
        while (action==1 ){
            for(naj=0;naj<na;naj++){
                if(x+15==xtarget[naj] && y+15==ytarget[naj]){
                    if(arm_on_tab[naj]==1){
                        if(set%2==0){
                            tirer(ren,2,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                            tirer(ren,4,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                            tirer(ren,6,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                            tirer(ren,8,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                        }else{
                            tirer(ren,1,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                            tirer(ren,3,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                            tirer(ren,7,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                            tirer(ren,9,x,y,ne,nm,xEnnemie,yEnnemie,StatutE,xMine,yMine,StatutM);
                        }
