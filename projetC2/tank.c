...
int evite_mer(SDL_Window* win, int x, int y,int lvl){
    ...
    switch (lvl){
        ...
        case (4):for(j=0;j<13;j++){
                    for(k=0;k<13;k++){
                        map[j][k]=map04[j][k];
                    }
                };break;
        case (5):for(j=0;j<13;j++){
                    for(k=0;k<13;k++){
                        map[j][k]=map05[j][k];
                    }
                };break;
        case (6):for(j=0;j<13;j++){
                    for(k=0;k<13;k++){
                        map[j][k]=map06[j][k];
                    }
                };break;
        case (7):for(j=0;j<13;j++){
                    for(k=0;k<13;k++){
                        map[j][k]=map07[j][k];
                    }
                };break;
        case (8):for(j=0;j<13;j++){
                    for(k=0;k<13;k++){
                        map[j][k]=map08[j][k];
                    }
                };break;
...
int Pos(int i,int a){
    ...
    int Pos4[3]={320,120,6};
    int Pos5[3]={470,570,6};
    int Pos6[3]={320,620,8};
    int Pos7[3]={470,20,2};
    int Pos8[3]={220,20,2};
    switch(i){
        ...
        case(4):b=Pos4[a];break;
        case(5):b=Pos5[a];break;
        case(6):b=Pos6[a];break;
        case(7):b=Pos7[a];break;
        case(8):b=Pos8[a];break;
    }
    return b;
}
int PosE(int i,int a){
    int b=0;
    int PosE1[12]={220,170,6,2000,2000,1,2000,2000,1,2000,2000,1};
    int PosE2[12]={420,470,6,620,370,4,2000,2000,1,2000,2000,1};
    int PosE3[12]={370,470,6,620,220,4,2000,2000,1,2000,2000,1};
    int PosE4[12]={70,120,6,570,120,4,420,520,6,2000,2000,1};
    int PosE5[12]={2000,2000,1,2000,2000,1,2000,2000,1,2000,2000,1};
    int PosE6[12]={170,470,6,470,320,4,570,620,8,2000,2000,1};
    int PosE7[12]={120,170,2,70,420,6,2000,2000,1,2000,2000,1};
    int PosE8[12]={370,220,2,470,220,6,470,420,6,470,520,6};
    switch(i){
        case(1):b=PosE1[a];break;
        case(2):b=PosE2[a];break;
        case(3):b=PosE3[a];break;
        case(4):b=PosE4[a];break;
        case(5):b=PosE5[a];break;
